...
export default function Services() {
    return (
        <section id="services" className="relative w-full bg-[#101317] py-20 sm:py-28 overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-16 sm:mb-20">
                    ...
                    <motion.div
                        ...
                        className="flex flex-col sm:flex-row items-start sm:items-center gap-6 max-w-md"
                    >
                        ...
                        <a
                            href="/services"
                            className="shrink-0 inline-flex items-center gap-2 bg-[#65C142] text-white font-semibold px-6 py-3 rounded-md hover:bg-[#52a034] transition-colors duration-300 whitespace-nowrap shadow-[0_10px_25px_rgba(101,193,66,0.3)]"
                        >
                            <span>See All</span>
                            <ArrowRight size={16} />
                        </a>
                ...
                <div className="hidden lg:block absolute left-0 right-0 top-[19rem] border-t-2 border-dashed border-[#65C142]/30 mx-24" />

                {/* Service cards with Full Glassmorphism Theme */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {services.map((service, i) => (
                        <motion.div
                            ...
                            className="relative flex flex-col items-center text-center p-6 rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.4)] hover:border-[#65C142]/50 transition-all duration-500 group"
                        >
                            {/* Arch image */}
