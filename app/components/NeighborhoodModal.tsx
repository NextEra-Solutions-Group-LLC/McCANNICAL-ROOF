...
const GOOGLE_REVIEW_URL = 'https://www.google.com/search?hl=en-BD&gl=bd&q=McCannical+Roofing+%26+Exteriors,+13785+Research+Blvd+Suite+125,+Austin,+TX+78750,+United+States&ludocid=6053404292023855261&lsig=AB86z5VAnpJG-gjaiXwVVKiY-IXP#lrd=0x665153e0765ca583:0x540203219be8289d,1'; // Replace with real place ID
                                ...
                                <div className="flex flex-col lg:flex-row gap-3">
                                    ...
                                    <div className="flex gap-2.5 sm:gap-3 shrink-0">
                                        <a
                                            ...
                                            className="flex-grow sm:flex-grow-0 flex items-center justify-center gap-2.5 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 px-4 py-3 transition-all hover:border-[#65C142]/40 group"
                                            title="View 4.9 Star Google Reviews"
                                        >
                                            {/* Google G Logo SVG */}
                                            ...
                                            <div className="flex items-center gap-1.5">
                                                <span className="text-xs sm:text-sm font-bold text-white tracking-wide">4.9</span>
                                                <div className="flex text-amber-400 gap-0.5">
                                                    {[...Array(5)].map((_, i) => (
                                                        <Star key={i} size={11} fill="currentColor" strokeWidth={0} />
                                                    ))}
                                                </div>
                                                <span className="text-xs font-semibold text-slate-400">(52)</span>
                                            </div>

                                            {/* <ExternalLink className="h-3.5 w-3.5 shrink-0 text-[#65C142] group-hover:translate-x-0.5 transition-transform" /> */}
                                        </a>
                                        <button
                                    ...
                                    <AnimatePresence mode="wait">
                                        {!selectedProject ? (
                                            ...
                                            >
                                                ...
                                                <div className="flex-grow overflow-y-auto p-5 sm:p-6 scrollbar-thin scrollbar-thumb-white/10 space-y-5">
                                                    
                                                    {/* 1. Project Photos AT THE TOP */}
                                                    <div className="space-y-2">
                                                        <div className="flex items-center justify-between text-xs text-slate-400 font-semibold px-1">
                                                            <span>Project Gallery ({selectedProject.images.length} Photos)</span>
                                                            <span className="text-[10px] text-[#65C142] font-bold">Click photo to enlarge</span>
                                                        </div>

                                                        <div className="grid grid-cols-3 gap-2.5 h-[190px] sm:h-[230px] md:h-[250px] relative shrink-0 w-full overflow-hidden">
                                                            {/* Left Big Image */}
                                                            <div 
                                                            ...
                                                            >
                                                                ...
                                                                <div className="absolute bottom-2.5 left-2.5 bg-black/75 backdrop-blur-md px-2.5 py-1 rounded-xl text-[10px] text-white font-bold flex items-center gap-1 shadow-lg pointer-events-none">
                                                                    <Maximize2 size={12} className="text-[#65C142]" /> View Fullscreen
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="col-span-1 flex flex-col gap-2.5 h-full overflow-hidden">
                                                                {selectedProject.images[1] && (
                                                                    <div 
                                                                        className="flex-grow h-1/2 rounded-xl overflow-hidden bg-black/40 border border-white/5 relative group cursor-pointer" 
                                                                ...
                                                                {selectedProject.images[2] && (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        {/* Photos Count Badge */}
                                                                        <div className="absolute right-2 bottom-2 bg-black/80 backdrop-blur-md px-2 py-1 rounded-lg border border-white/10 flex items-center gap-1 text-[9px] font-bold text-white shadow-lg pointer-events-none">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-[#65C142]">
                                                    ...
                                                    {/* 2. Project Description Block */}
                                                    <div className="p-4 sm:p-5 rounded-2xl bg-white/[0.03] border border-white/10 space-y-2.5 shadow-md">
                                                        <div className="flex items-center justify-between text-xs text-[#65C142] font-bold uppercase tracking-wider">
                                                            <span className="flex items-center gap-1.5">
                                                                <MapPin size={13} /> {selectedProject.locationName}
                                                            </span>
                                                            <span className="flex items-center gap-1 text-amber-400">
                                                                <Star size={12} fill="currentColor" strokeWidth={0} />
                                                                <span className="text-white text-xs font-bold">{selectedProject.rating}.0 Rating</span>
                                                            </span>
                                                        </div>
                                                    ...
                                                    {/* 3. Client Review & Owner Response Block */}
                                                    {selectedProject.review && (
                                                        <div className="border-t border-white/5 pt-2">
                                                            <div className="bg-white/[0.02] border border-[#65C142]/20 rounded-2xl p-4 sm:p-5 relative overflow-hidden">
                                                                <Quote className="absolute right-4 top-4 text-[#65C142]/10 h-16 w-16 -z-10 pointer-events-none" strokeWidth={1} />
